---
title: "Wrangling Business Data by \"cleandata\" v0.2.0"
author: "Sherry Zhao"
...
Issues and Suggestions: [https://github.com/sherrisherry/cleandata/issues](https://github.com/sherrisherry/cleandata/issues)
...
df0 <- encode_onehot(df[, i, drop=FALSE], log = log_arg)
df[, i] <- NULL
df <- cbind(df, df0)
```
...
df0 <- partition_random(df[!is.na(df$SalePrice),], train = 8, test = FALSE, log = log_arg)
```
